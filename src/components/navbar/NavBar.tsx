       ...
       <>
        ...
        <div>
            {currentPath.includes("post-question") ?
                ...
                <nav className="flex justify-between items-center bg-[#ffffff] shadow-md fixed right-0 left-[280px] px-[24px] lg:pt-[15px] sm:pt-[5px] md:pt-[6px] pb-[20px]">
                    ...
                    <div>
                        {currentPath.includes("personal-details") ||
                            ...
                            currentPath.includes("account-management") ||
                            currentPath.includes("view-comment") ?
                            <div className="sm:w-[10vh] mr-3">
                                <BackButton />
                            </div> : <h1 className="font-bold text-[20px]">Welcome back, {username}</h1>}
                    </div>
                    <div className="flex align-center gap-[20px]">
                        <div className="flex gap-[8px] border-[1px] border-[#999999] px-[16px] py-[12px] rounded-[100px] lg:w-[300px] sm:w-[110px] sm:rounded-[40px]">
                            <img src={SearchIcon} alt="search icon" className="lg:grid sm:hidden" />
                            <input type='search' placeholder="search here" className="text-[#99999] border-none outline-none " />
                        </div>
                        <div className="flex flex-col gap-[4px]">
                            <h3 className="font-[400] text-[20px]">Wednesday, May 21, 2025</h3>
                        ...
                        <div className="flex items-center gap-[10px]">
                            <div className="rounded-[50%] bg-[#999999] pt-[13px] pl-[16px] lg:w-[50px] h-[50px] sm:w-[60px] ">
                                <p className="font-[700] text-[#fff]">JA</p>
                            </div>
                            <div className="flex-col">
                                <h3 className="font-[400] text-[20px]">John Adekola</h3>
