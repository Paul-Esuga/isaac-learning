...
const FaqsCard = ( { heading, body }: FaqsCardProps ) => {
    ...
    return (
        <div className={`w-[600px] border-[1px] w-[100%] ${showDropDownContent ? "h-[fit-content]" : "h-[70px]"} rounded-[10px] px-[20px] pt-[20px] pb-[10px] flex flex-col justify-between m-[10px]`}>
