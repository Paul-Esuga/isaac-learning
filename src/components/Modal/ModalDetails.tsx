...
export const ModalDetails = ({ setIsFormFilled }: { setIsFormFilled: React.Dispatch<React.SetStateAction<boolean>> }) => {
  ...
  return (
    <div className='align-middle items-center justify-center rounded-xl'>
      ...
      <button className='bg-primary-green text-[#FCFCFC] text-base font-bold w-[100%] rounded-md p-2 mt-2 mb-2 opacity-100 cursor-pointer' onClick={() => { setIsFormFilled(false), navigate('/dashboard') }}>Proceed to homepage</button>
    </div>
  )
}